...
<details>
  ...
  1.  (optionally) Generate unique `token1` and `sign` (see
      [Request signature](/en/get-started/backend/sign)).
  1.  Call [/GetBalance](/en/get-started/wallet/#operation/getBalance) method.
  1.  IFRAME Service will send a [/GetUserData](/en/get-started/wallet/#operation/getUserData)
...
<details>
  ...
  1.  (optionally) Generate unique `token1` and `sign` (see
      [Request signature](/en/get-started/backend/sign)).
  1.  Call [/TransferFunds](/en/get-started/wallet/#operation/transferFunds) method with operation
